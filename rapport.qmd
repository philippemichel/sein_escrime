---
subtitle: "Rapport Statistique - V 4.0 (eng)"
cache: false
---
...
```{r}
#| label: violevol-eng
#| fig-cap: "Evolution of the overall scores of the SF36"
tt |> 
  dplyr::select(36:37) |>
  pivot_longer(1:2) |>
  mutate(name = factor(name, levels = c("sf36p_dif", "sf36m_dif"),labels = c("physical functioning", "emotional well-being"))) |>
  ggplot() +
#    +
  aes(x= name, y = value, fill = name) +
  geom_violin() +
  geom_boxplot(width = 0.2, fill = "grey90") +
    scale_fill_discrete_qualitative(palette = "Dark 3") +   
  geom_hline(yintercept = 0,linetype = "dotdash", color = "grey40") +
  labs(title = "Evolution of the overall scores of the SF36",
      y = "n",
      caption = ""
      ) +
  theme_light() +
...
tta |> 
  ...
  annotate("text",x = 90, y = 25, label = ccp, size = 5) +
    labs(title = "SF36 (physical) :  \n evolution according to the initial score",
        x ="Initial physical SF36 score",
       y = "Evolution of physical SF36",
       caption = "") +
  theme_light() +
  scale_fill_discrete_qualitative(palette = "Dark 3") +
  theme(
...
tta |> 
  ...
  annotate("text",x = 85, y = 30, label = ccp, size = 5) +
    labs(title = "SF36 (emotional well-being) :  \n evolution according to the initial score",
             x ="Initial mental SF36 score",
       y = "Evolution of mental SF36",
       caption = "")+
  theme_light() +
  scale_fill_discrete_qualitative(palette = "Dark 3") +
  theme(
